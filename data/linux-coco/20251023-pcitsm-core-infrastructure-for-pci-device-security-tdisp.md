...
message_count: 43
participants: ['Dan Williams', 'Aneesh Kumar K.V', 'kernel test robot', 'Alexey Kardashevskiy', 'Jonathan Cameron', 'Carlos López', 'Bjorn Helgaas']
---

## [1] Dan Williams — 2025-10-23
...
## [11] Aneesh Kumar K.V — 2025-10-25
...
## [12] kernel test robot — 2025-10-26
...
## [13] Aneesh Kumar K.V — 2025-10-27
...
## [14] Alexey Kardashevskiy — 2025-10-29
*Subject: Re: [PATCH v7 0/9] PCI/TSM: Core infrastructure for PCI device
 security (TDISP)*
...
## [18] Jonathan Cameron — 2025-10-29
*Subject: Re: [PATCH v7 4/9] PCI/TSM: Establish Secure Sessions and Link
 Encryption*
...
## [20] dan.j.williams@intel.com — 2025-10-29
*Subject: Re: [PATCH v7 3/9] PCI: Introduce pci_walk_bus_reverse(),
 for_each_pci_dev_reverse()*
...
## [24] dan.j.williams@intel.com — 2025-10-29
*Subject: Re: [PATCH v7 7/9] PCI/IDE: Add IDE establishment helpers*
...
## [25] dan.j.williams@intel.com — 2025-10-29
...
## [26] dan.j.williams@intel.com — 2025-10-29
*Subject: Re: [PATCH v7 2/9] PCI/IDE: Enumerate Selective Stream IDE
 capabilities*
...
## [27] Alexey Kardashevskiy — 2025-10-30
*Subject: Re: [PATCH v7 2/9] PCI/IDE: Enumerate Selective Stream IDE
 capabilities*
...
## [28] Alexey Kardashevskiy — 2025-10-30
*Subject: Re: [PATCH v7 1/9] coco/tsm: Introduce a core device for TEE Security
 Managers*
...
## [29] Alexey Kardashevskiy — 2025-10-30
*Subject: Re: [PATCH v7 4/9] PCI/TSM: Establish Secure Sessions and Link
 Encryption*
...
## [30] Alexey Kardashevskiy — 2025-10-30
*Subject: Re: [PATCH v7 9/9] PCI/TSM: Report active IDE streams*
...
## [31] Aneesh Kumar K.V — 2025-10-30
*Subject: Re: [PATCH v7 2/9] PCI/IDE: Enumerate Selective Stream IDE
 capabilities*
...
## [32] Aneesh Kumar K.V — 2025-10-30
*Subject: Re: [PATCH v7 4/9] PCI/TSM: Establish Secure Sessions and Link
 Encryption*
...
## [34] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 3/9] PCI: Introduce pci_walk_bus_reverse(),
 for_each_pci_dev_reverse()*
...
## [35] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 4/9] PCI/TSM: Establish Secure Sessions and Link
 Encryption*
...
## [36] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 8/9] PCI/IDE: Report available IDE streams*
...
## [37] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 9/9] PCI/TSM: Report active IDE streams*
...
## [38] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 2/9] PCI/IDE: Enumerate Selective Stream IDE
 capabilities*
...
## [40] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 1/9] coco/tsm: Introduce a core device for TEE Security
 Managers*
...
## [41] Alexey Kardashevskiy — 2025-10-31
*Subject: Re: [PATCH v7 2/9] PCI/IDE: Enumerate Selective Stream IDE
 capabilities*
...
## [42] dan.j.williams@intel.com — 2025-10-30
*Subject: Re: [PATCH v7 2/9] PCI/IDE: Enumerate Selective Stream IDE
 capabilities*
