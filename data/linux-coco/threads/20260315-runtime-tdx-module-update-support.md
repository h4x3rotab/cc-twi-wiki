...
message_count: 80
participants: ['Chao Gao', 'Huang, Kai', 'Kiryl Shutsemau', 'Dave Hansen', 'Xiaoyao Li']
---

## [1] Chao Gao — 2026-03-15
...
## [2] Chao Gao — 2026-03-15
*Subject: [PATCH v5 01/22] x86/virt/tdx: Move low level SEAMCALL helpers out of <asm/tdx.h>*
...
## [3] Chao Gao — 2026-03-15
*Subject: [PATCH v5 02/22] coco/tdx-host: Introduce a "tdx_host" device*
...
## [4] Chao Gao — 2026-03-15
*Subject: [PATCH v5 03/22] coco/tdx-host: Expose TDX module version*
...
## [5] Chao Gao — 2026-03-15
*Subject: [PATCH v5 04/22] x86/virt/seamldr: Introduce a wrapper for P-SEAMLDR SEAMCALLs*
...
## [6] Chao Gao — 2026-03-15
*Subject: [PATCH v5 05/22] x86/virt/seamldr: Retrieve P-SEAMLDR information*
...
## [7] Chao Gao — 2026-03-15
*Subject: [PATCH v5 06/22] coco/tdx-host: Expose P-SEAMLDR information via sysfs*
...
## [8] Chao Gao — 2026-03-15
*Subject: [PATCH v5 07/22] coco/tdx-host: Implement firmware upload sysfs ABI for TDX module updates*
...
## [9] Chao Gao — 2026-03-15
*Subject: [PATCH v5 08/22] x86/virt/seamldr: Allocate and populate a module update request*
...
## [10] Chao Gao — 2026-03-15
*Subject: [PATCH v5 09/22] x86/virt/seamldr: Introduce skeleton for TDX module updates*
...
## [11] Chao Gao — 2026-03-15
*Subject: [PATCH v5 10/22] x86/virt/seamldr: Abort updates if errors occurred midway*
...
## [12] Chao Gao — 2026-03-15
*Subject: [PATCH v5 11/22] x86/virt/seamldr: Shut down the current TDX module*
...
## [13] Chao Gao — 2026-03-15
*Subject: [PATCH v5 12/22] x86/virt/tdx: Reset software states during TDX module shutdown*
...
## [14] Chao Gao — 2026-03-15
*Subject: [PATCH v5 13/22] x86/virt/seamldr: Install a new TDX module*
...
## [15] Chao Gao — 2026-03-15
*Subject: [PATCH v5 14/22] x86/virt/seamldr: Do TDX per-CPU initialization after updates*
...
## [16] Chao Gao — 2026-03-15
*Subject: [PATCH v5 15/22] x86/virt/tdx: Restore TDX module state*
...
## [17] Chao Gao — 2026-03-15
*Subject: [PATCH v5 16/22] x86/virt/tdx: Update tdx_sysinfo and check features post-update*
...
## [18] Chao Gao — 2026-03-15
*Subject: [PATCH v5 17/22] x86/virt/tdx: Avoid updates during update-sensitive operations*
...
## [19] Chao Gao — 2026-03-15
*Subject: [PATCH v5 18/22] coco/tdx-host: Don't expose P-SEAMLDR features on CPUs with erratum*
...
## [20] Chao Gao — 2026-03-15
*Subject: [PATCH v5 19/22] x86/virt/tdx: Enable TDX module runtime updates*
...
## [21] Chao Gao — 2026-03-15
*Subject: [PATCH v5 20/22] coco/tdx-host: Document TDX module update compatibility criteria*
...
## [23] Chao Gao — 2026-03-15
*Subject: [PATCH v5 22/22] x86/virt/seamldr: Log TDX module update failures*
...
## [24] Huang, Kai — 2026-03-16
*Subject: Re: [PATCH v5 12/22] x86/virt/tdx: Reset software states during TDX
 module shutdown*
...
## [25] Kiryl Shutsemau — 2026-03-16
*Subject: Re: [PATCH v5 01/22] x86/virt/tdx: Move low level SEAMCALL helpers
 out of <asm/tdx.h>*
...
## [26] Kiryl Shutsemau — 2026-03-16
*Subject: Re: [PATCH v5 02/22] coco/tdx-host: Introduce a "tdx_host" device*
...
## [27] Kiryl Shutsemau — 2026-03-16
*Subject: Re: [PATCH v5 03/22] coco/tdx-host: Expose TDX module version*
...
## [28] Kiryl Shutsemau — 2026-03-16
*Subject: Re: [PATCH v5 04/22] x86/virt/seamldr: Introduce a wrapper for
 P-SEAMLDR SEAMCALLs*
...
## [29] Kiryl Shutsemau — 2026-03-16
*Subject: Re: [PATCH v5 05/22] x86/virt/seamldr: Retrieve P-SEAMLDR information*
...
## [35] Kiryl Shutsemau — 2026-03-17
*Subject: Re: [PATCH v5 06/22] coco/tdx-host: Expose P-SEAMLDR information via
 sysfs*
...
## [36] Kiryl Shutsemau — 2026-03-17
*Subject: Re: [PATCH v5 07/22] coco/tdx-host: Implement firmware upload sysfs
...
## [37] Kiryl Shutsemau — 2026-03-17
*Subject: Re: [PATCH v5 08/22] x86/virt/seamldr: Allocate and populate a
...
## [51] Huang, Kai — 2026-03-18
*Subject: Re: [PATCH v5 08/22] x86/virt/seamldr: Allocate and populate a module
 update request*
...
## [56] Huang, Kai — 2026-03-18
*Subject: Re: [PATCH v5 09/22] x86/virt/seamldr: Introduce skeleton for TDX
 module updates*
...
## [62] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 10/22] x86/virt/seamldr: Abort updates if errors
 occurred midway*
...
## [63] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 11/22] x86/virt/seamldr: Shut down the current TDX
 module*
...
## [64] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 13/22] x86/virt/seamldr: Install a new TDX module*
...
## [65] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 14/22] x86/virt/seamldr: Do TDX per-CPU initialization
 after updates*
...
## [66] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 15/22] x86/virt/tdx: Restore TDX module state*
...
## [67] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 16/22] x86/virt/tdx: Update tdx_sysinfo and check
...
## [68] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 17/22] x86/virt/tdx: Avoid updates during
...
## [69] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 18/22] coco/tdx-host: Don't expose P-SEAMLDR features
...
## [70] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 19/22] x86/virt/tdx: Enable TDX module runtime updates*
...
## [71] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 20/22] coco/tdx-host: Document TDX module update
...
## [73] Kiryl Shutsemau — 2026-03-19
*Subject: Re: [PATCH v5 22/22] x86/virt/seamldr: Log TDX module update failures*
