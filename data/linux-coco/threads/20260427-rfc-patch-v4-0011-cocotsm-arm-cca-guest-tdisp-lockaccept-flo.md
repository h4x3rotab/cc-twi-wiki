---
title: '[RFC PATCH v4 00/11] coco/TSM: Arm CCA guest TDISP lock/accept flow with verification and DMA enable'
date: 2026-04-27
...
*Subject: [RFC PATCH v4 01/11] coco: guest: arm64: Guest TSM callback and realm device lock support*
...
*Subject: [RFC PATCH v4 02/11] coco: guest: arm64: Fix a typo in the ARM_CCA_GUEST Kconfig help string ("and" -> "an").*
...
*Subject: [RFC PATCH v4 03/11] coco: guest: arm64: Add Realm Host Interface and guest DA helper*
...
*Subject: [RFC PATCH v4 04/11] coco: guest: arm64: Support guest-initiated TDI lock/unlock transitions*
...
*Subject: [RFC PATCH v4 05/11] coco: guest: arm64: Refresh interface-report cache during device lock*
...
*Subject: [RFC PATCH v4 07/11] coco: guest: arm64: Add guest APIs to read host-cached DA objects*
...
*Subject: [RFC PATCH v4 10/11] coco: arm64: dma: Update force_dma_unencrypted for accepted devices*
