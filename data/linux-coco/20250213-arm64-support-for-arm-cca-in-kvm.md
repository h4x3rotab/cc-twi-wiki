...
date: 2025-02-13
last_reply: 2025-04-09
message_count: 102
participants: ['Steven Price', 'Aneesh Kumar K.V', 'Gavin Shan', 'Suzuki K Poulose', 'Emi Kisanuki (Fujitsu)', 'Oliver Upton', 'Wei-Lin Chang']
---

## [1] Steven Price — 2025-02-13
...
## [4] Steven Price — 2025-02-13
*Subject: [PATCH v7 03/45] arm64: RME: Handle Granule Protection Faults (GPFs)*
...
## [47] Aneesh Kumar K.V — 2025-02-14
...
## [61] Suzuki K Poulose — 2025-03-03
...
## [78] Suzuki K Poulose — 2025-03-04
...
## [86] Emi Kisanuki (Fujitsu) — 2025-03-26
*Subject: RE: [PATCH v7 00/45] arm64: Support for Arm CCA in KVM*
...
## [88] Emi Kisanuki (Fujitsu) — 2025-04-01
*Subject: RE: [PATCH v7 00/45] arm64: Support for Arm CCA in KVM*
...
1. Launching the realm VM using Internal simulator $B"*(B Successfully launched by disabling MPAM support in the ID register.
2. Running kvm-unit-tests (with lkvm) $B"*(B All tests passed except for PMU (as expected, since PMU is not supported by the Internal simulator).[1]
