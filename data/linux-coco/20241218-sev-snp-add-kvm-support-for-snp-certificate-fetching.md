...
date: 2024-12-18
last_reply: 2025-01-10
message_count: 5
participants: ['Michael Roth', 'Dionna Amalie Glaze', 'Liam Merwick']
---

## [1] Michael Roth — 2024-12-18
...
## [4] Dionna Amalie Glaze — 2025-01-08
*Subject: Re: [PATCH v3] KVM: Introduce KVM_EXIT_SNP_REQ_CERTS for SNP certificate-fetching*

On Wed, Dec 18, 2024 at 7:23 AM Michael Roth <michael.roth@amd.com> wrote:
>
> For SEV-SNP, the host can optionally provide a certificate table to the
